...
<div class="netreviews_bg_stars_big">
   ...
   <div style="color:#{$customized_star_color|escape:'htmlall':'UTF-8'}">
      {for $av_star=0 to $average_rate_percent.floor}<span class="nr-icon nr-star"></span>{/for}{if $average_rate_percent.decimals}<span class="nr-icon nr-star" style="width:{$average_rate_percent.decimals|escape:'htmlall':'UTF-8'}%;display: inline-flex;"></span>{/if}
   </div>  
</div> 
